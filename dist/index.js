...
function compiler(loader, text) {
    ...
    var rawFileName = helpers.toUnix(loader.resourcePath);
    var appendTsSuffixTo = Array.isArray(query.appendTsSuffixTo) ? query.appendTsSuffixTo.map(function (value) { return new RegExp(value); }) : [];
    var fileName = helpers.appendTsSuffixIfMatch(appendTsSuffixTo || [], rawFileName);
